...
//       Always applied, not just for literal arguments.  The capture-
//       avoiding substitution is the same as in fold_constants but
//       without the "literal only" restriction.
//
//     Inlining
